...
async function storeEvent(req, res) {
  try {
    ...
    error.errors?.shortDescription
      ? (errorMessage.shortDescription = error.errors.shortDescription.message)
      : null;
    error.errors?.longDescription
      ? (errorMessage.longDescription = error.errors.longDescription.message)
      : null;
    error.errors?.cover
      ? (errorMessage.cover = error.errors.cover.message)
      : null;
    error.errors?.time ? (erroricon.time = error.errors.time.message) : null;
    error.errors?.date ? (erroricon.date = error.errors.time.message) : null;
    error.errors?.location
      ? (erroricon.location = error.errors.time.message)
      : null;
